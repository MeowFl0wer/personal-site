...
// The warm end of the ground wash — what sits behind the browser chrome at the
// top of a page. Mirrors --wash-warm in globals.css.
export const viewport: Viewport = { themeColor: "#f8ece4" };
